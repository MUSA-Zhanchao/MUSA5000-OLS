...
# histograms of the original variables
p1 <- ggplot(data, aes(x = MEDHVAL)) + geom_histogram(bins = 30, fill = "blue", alpha = 0.7) + ggtitle("Median House Value")
p2 <- ggplot(data, aes(x = PCTBACHMOR)) + geom_histogram(bins = 30, fill = "blue", alpha = 0.7) + ggtitle("% with Bachelor’s Degree")
p3 <- ggplot(data, aes(x = NBELPOV100)) + geom_histogram(bins = 30, fill = "blue", alpha = 0.7) + ggtitle("# Households in Poverty")
p4 <- ggplot(data, aes(x = PCTVACANT)) + geom_histogram(bins = 30, fill = "blue", alpha = 0.7) + ggtitle("% Vacant Houses")
p5 <- ggplot(data, aes(x = PCTSINGLES)) + geom_histogram(bins = 30, fill = "blue", alpha = 0.7) + ggtitle("% Single House Units")

# histograms of the transformed variables
p6 <- ggplot(data, aes(x = LNMEDHVAL)) + geom_histogram(bins = 30, fill = "red", alpha = 0.7) + ggtitle("Log Median House Value")
p7 <- ggplot(data, aes(x = LNPCTBACHMOR)) + geom_histogram(bins = 30, fill = "red", alpha = 0.7) + ggtitle("Log % with Bachelor’s Degree")
p8 <- ggplot(data, aes(x = LNNBELPOV100)) + geom_histogram(bins = 30, fill = "red", alpha = 0.7) + ggtitle("Log # Households in Poverty")
p9 <- ggplot(data, aes(x = LNPCTVACANT)) + geom_histogram(bins = 30, fill = "red", alpha = 0.7) + ggtitle("Log % Vacant Houses")
p10 <- ggplot(data, aes(x = LNPCTSINGLES)) + geom_histogram(bins = 30, fill = "red", alpha = 0.7) + ggtitle("Log % Single House Units")
